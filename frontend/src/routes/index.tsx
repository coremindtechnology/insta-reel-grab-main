...
function Index() {
  ...
  const validUrl = useMemo(
    () => (url ? isInstagramUrlInput(url) : false),
    [url],
  );
  ...
  async function processUrl(autoDownload = false) {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.error || "Unable to process this Instagram URL.",
        );
      }
  ...
  async function pasteFromClipboard() {
    try {
      ...
      if (err.name === "NotAllowedError") {
        toast.error(
          "Clipboard blocked! Please click the icon next to the URL bar and Allow 'Clipboard' access.",
          {
            duration: 6000,
          },
        );
        ...
        toast.error(
          "Unable to read clipboard. Please paste manually (Ctrl+V).",
        );
      }
    }
  }
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-2.5rem)] w-full flex-col pt-20">
        <section className="flex-1 space-y-8 py-8 lg:py-12 w-full">
          ...
          {media && (
            <div
              id="results"
              className="animate-rise space-y-8 max-w-4xl mx-auto w-full pt-8"
            >
              {mode === "reels" ? (
                <div className="flex flex-col lg:flex-row gap-8 items-start justify-center">
                            ...
                            <>
                              ...
                              <div className="absolute bottom-6 left-6 right-6 text-white text-left pointer-events-none">
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="h-8 w-8 rounded-full bg-gradient-to-tr from-blue-400 via-sky-400 to-cyan-500 p-0.5">
                                ...
                                <p className="text-xs line-clamp-2 drop-shadow-md opacity-90">
                                  {media.title}
                                </p>
                              </div>
                            </>
                  ...
                  <div className="flex-1 w-full space-y-6 pt-4 lg:pt-10">
                    <div className="space-y-4">
                      ...
                      <h3 className="font-black text-foreground text-3xl sm:text-4xl leading-tight tracking-tight">
                        Download reel
                      </h3>
                    </div>
                    ...
                    <div className="grid gap-5">
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          Download Video (MP4)
                          <div className="ml-auto bg-white/20 px-3 py-1 rounded-lg text-xs font-bold">
                            1080p
                          </div>
                        </Button>
                      </div>
                    ...
                    <div className="bg-secondary/20 rounded-2xl p-4 border border-border/50 flex items-start gap-3">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed">
                        Your download will start automatically via our
                        high-speed proxy server. No watermarks will be added to
                        the final file.
                      </p>
                    </div>
                  </div>
                ...
                <div className="glass-panel rounded-3xl p-6 sm:p-8 max-w-2xl mx-auto shadow-2xl border border-border/50 bg-card/60 backdrop-blur-3xl space-y-6">
                  ...
                  <div className="grid gap-3.5 pt-4">
                    <Button
                      variant="instagram"
                      size="lg"
                      className="w-full h-14 text-lg font-black rounded-2xl shadow-app-lg transition-all active:scale-[0.98]"
                      onClick={() => openDownload(media, "audio")}
                    >
              ...
              <ul className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <li className="flex gap-3">
                  ...
                  <span className="text-sm text-muted-foreground">
                    <strong>High-Quality MP3:</strong> Extract audio in the best
                    possible quality for clear listening.
                  </span>
                </li>
                <li className="flex gap-3">
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                  ...
                  <span className="text-sm text-muted-foreground">
                    <strong>Fast & Efficient:</strong> Get your MP3 links in
                    seconds with our high-speed extraction system.
                  </span>
                </li>
                <li className="flex gap-3">
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                  ...
                  <span className="text-sm text-muted-foreground">
                    <strong>No Registration Required:</strong> Start downloading
                    audio immediately without creating an account.
                  </span>
                </li>
                <li className="flex gap-3">
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                  ...
                  <span className="text-sm text-muted-foreground">
                    <strong>One-Click Extraction:</strong> Easily convert any
                    Instagram Reel or video to MP3 with a single click.
                  </span>
                </li>
                <li className="flex gap-3">
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                  ...
                  <span className="text-sm text-muted-foreground">
                    <strong>Multi-Device Compatibility:</strong> Works perfectly
                    on all mobile, tablet, and desktop web browsers.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="mt-16 space-y-12 pt-10 border-t border-border/30 w-full max-w-7xl mx-auto">
              <div className="text-center space-y-4">
                <h2 className="text-3xl font-black text-primary">
                  Ways to Download Instagram Audio
                </h2>
                <p className="max-w-4xl mx-auto text-muted-foreground">
                  SaveReelAudio provides an easy way to extract audio from
                  Instagram Reels. Just follow these simple steps to download
                  MP3s. We guide you with images to make it even easier to
              ...
              <div className="grid gap-12 sm:grid-cols-3">
                <div className="flex flex-col items-center text-center space-y-6">
                  ...
                  <div className="w-full aspect-video overflow-hidden rounded-2xl border border-border shadow-sm bg-secondary/30">
                    <img
                      src="/guide/step1.png"
                      alt="Reels to Download"
                      className="h-full w-full object-cover"
                    />
                  </div>
                  <p className="text-sm leading-relaxed text-muted-foreground px-2">
                    Open the IG app and copy your favourite Reels that you want
                    to download. Just click on the share icon and then click on
                    the copy link icon.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center text-center space-y-6">
                  ...
                  <p className="text-sm leading-relaxed text-muted-foreground px-2">
                    Paste the link in the SaveReelAudio Reels Downloader and
                    click search to start processing your request. The Reels
                    downloader will prepare your Reels in seconds.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center text-center space-y-6">
                  ...
                  <div className="w-full aspect-video overflow-hidden rounded-2xl border border-border shadow-sm bg-secondary/30">
                    <img
                      src="/guide/step3.png"
                      alt="Save Instagram Audio"
                      className="h-full w-full object-cover"
                    />
                  </div>
                  <p className="text-sm leading-relaxed text-muted-foreground px-2">
                    Click on the download button to download the Instagram
                    Reels, and the Reels will be saved in your downloads folder
                    or phone gallery. Now you can enjoy your high-quality
                    downloaded Reels.
                  </p>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="relative aspect-[4/3] overflow-hidden rounded-3xl border border-border shadow-2xl">
                  <img
                    ...
                    alt="No Watermark Instagram Reels Download"
            ...
            <div className="lg:w-1/2 space-y-6">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  <strong>Download Instagram Audio in High Quality</strong>?
                  You've come to the right place. Our advanced extractor ensures
                  that every MP3 you save is in its best available quality,
                  perfect for listening on any device or using in your own
                  projects.
                </p>
                <p>
                  Unlike many other tools, our system prioritizes audio
                  fidelity. When you use SaveReelAudio for your{" "}
                  <strong>Instagram Reels audio download</strong>, we fetch the
                  highest bit-rate stream available. Whether it's a 128kbps or
                  320kbps source, you get the clearest audio saved locally on
                  your device.
                </p>
                <p>
                  The process is completely free and requires no registration.
                  We believe that accessing your favorite audio should be simple
                  and fast. Our servers are optimized to handle extractions in
                  seconds, meaning you don't have to wait around. Just paste the
                  link, and let our engine do the heavy lifting for you.
                </p>
                <p>
                  Compatibility is never an issue. You can download audio on
                  your iPhone, Android, or PC without any additional software.
                  Our web-based platform is fully responsive and secure,
                  ensuring that your data remains private while you get the best{" "}
                  <strong>Instagram MP3 download</strong> experience available
                  today.
                </p>
              </div>
            </div>
          ...
          <div className="mt-20 space-y-12 pt-16 border-t border-border/30 animate-rise w-full max-w-7xl mx-auto">
            ...
            <div className="grid gap-4 max-w-3xl mx-auto">
              <div className="flex gap-5 items-start glass-panel p-5 rounded-2xl border border-border/50">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-primary text-primary-foreground font-bold shadow-app">
                  1
                </div>
                <p className="text-foreground leading-relaxed pt-2">
                  Copy the link of your Instagram Reels video which you want to
                  download.
                </p>
              </div>
              <div className="flex gap-5 items-start glass-panel p-5 rounded-2xl border border-border/50">
                ...
                <p className="text-foreground leading-relaxed pt-2">
                  Open{" "}
                  <span className="font-bold text-primary">SaveReelAudio</span>{" "}
                  for Instagram reels download.
                </p>
              </div>
              <div className="flex gap-5 items-start glass-panel p-5 rounded-2xl border border-border/50">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-primary text-primary-foreground font-bold shadow-app">
                ...
                <p className="text-foreground leading-relaxed pt-2">
                  Now, paste the copied URL into the input box.
                </p>
              </div>
              <div className="flex gap-5 items-start glass-panel p-5 rounded-2xl border border-border/50">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-primary text-primary-foreground font-bold shadow-app">
                ...
                <p className="text-foreground leading-relaxed pt-2">
                  Audio downloader automatically sync your reel and creates a
              ...
              <div className="flex gap-5 items-start glass-panel p-5 rounded-2xl border border-border/50">
                ...
                <p className="text-foreground leading-relaxed pt-2">
                  Hit on the download button to save the audio. See how easy it
                  is!
                </p>
              </div>
            </div>
          ...
          <div className="mt-24 space-y-12 pt-16 border-t border-border/30 animate-rise w-full max-w-7xl mx-auto">
            <div className="text-center space-y-4">
              <h2 className="text-3xl sm:text-4xl font-black text-foreground">
                How to copy link for Instagram Reels Download?
              </h2>
              <p className="max-w-2xl mx-auto text-muted-foreground">
                Follow these simple steps to copy the link of any Instagram Reel
                you want to download. It's quick and easy!
              </p>
            </div>
            ...
            <div className="grid gap-12 sm:grid-cols-3">
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed px-2">
                    Open Instagram and choose the reels which you want to
                    download or save.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed px-2">
                    At the bottom, click on the 3 dots icon. A popup menu will
                    open.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed px-2">
                    Click on the Copy Link option. That’s it! Your link is
                    copied.
                  </p>
                </div>
              </div>
